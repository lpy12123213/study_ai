...
class ZujuanCrawler:
    ...
    async def _fallback_question_list(
        ...
        from backend.crawler.zujuan.question_list import fallback_question_list as impl
    ...
    async def _fetch_question_list(
        ...
        from backend.crawler.zujuan.question_list import fetch_question_list as impl
    ...
    async def _parse_questions_from_html(
        ...
        *,
        ...
        from backend.crawler.zujuan.question_parsing import parse_questions_from_html as impl
    ...
    async def _batch_convert_formulas(
        ...
        *,
        ...
        from backend.crawler.zujuan.question_parsing import batch_convert_formulas as impl
    ...
    async def get_knowledge_tree(self) -> Dict[str, Any]:
        from backend.crawler.zujuan.knowledge_tree import get_knowledge_tree as impl
    ...
    def _parse_knowledge_sidebar(
        ...
        from backend.crawler.zujuan.knowledge_tree import parse_knowledge_sidebar as impl
    ...
    def _parse_sidebar_container(self, container, RE_ZSD_ID) -> List[Dict[str, Any]]:
        from backend.crawler.zujuan.knowledge_tree import parse_sidebar_container as impl
