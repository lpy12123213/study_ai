...
from backend.integrations.mcp.search._base import FunctionSearchProvider, SearchProvider, register_search_provider
...
async def _github_search(query: str, limit: int) -> dict[str, Any]:
    from backend.integrations.mcp.search.github import github_search_repositories
...
async def _metaso_search(query: str, limit: int) -> dict[str, Any]:
    from backend.integrations.mcp.search.metaso import metaso_search
