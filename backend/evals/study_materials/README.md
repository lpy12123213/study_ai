...
python -m backend.evals.study_materials.runner --case light           # 高中主线 + 受控大学拓展 11 例，自动 4 并发
...
- `case_schema.py` — 单用例/case pack schema、高中/受控拓展范围、动态学习闭环协议；`cases/` — 43 个逻辑用例
