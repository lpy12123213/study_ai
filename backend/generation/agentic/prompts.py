...
PROMPT_INVENTORY_TARGETS: Tuple[str, ...] = (
    ...
    "backend/question_library/brainstorm.py",
    "backend/question_library/draft_realization.py",
    "backend/question_library/generation.py",
    "backend/question_library/judging.py",
    "backend/api/question_evaluate.py",
    "backend/lesson_plan/prompts.py",
    "backend/lesson_plan/planning.py",
    "backend/lesson_plan/writing.py",
    "backend/lesson_plan/export.py",
    "backend/deepthink/prompts.py",
    "backend/chat/prompts.py",
    "backend/generation/knowledge_video/llm.py",
    "backend/mcp/tools/stdio_handlers.py",
    "backend/mcp/tools/reviewer.py",
)
    ...
    for template in (
        _json_template(
            ...
            body=(
                ...
                "assemble/save/export/review and close the run.\n"
