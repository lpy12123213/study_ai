...
- 当前数据库快照：物理 1,831 题、化学 2,565 题；两科每题均有来源记录，年份均覆盖 2007–2026。答案非空分别为 1,160、2,055，仍全部标记为未核验。
...
- 图形：题面和答案共有 5,221 个本地 SVG 引用（3,947 个唯一文件），另有 8,142 个已登记 SVG 侧车，均已注册、哈希/大小一致且文件存在；远程 `<img src>` 为 0。EOL 2015 新增 9 个 SVG 侧车（题面 5 张、答案 4 张）；EOL 2016–2021 视觉卷新增 95 个 SVG 侧车并复用 1 个，题面 76 张、答案 20 张；EOL 2022–2024 视觉卷新增 126 个 SVG 侧车（题面 86 张、答案 63 张）；另有 3 道化学题的 11 个残留远程图片已转为本地 SVG；2023 PDF 批次新增 81 个整页 SVG 侧车，题目引用 239 次；2023 化学 PDF 新增 29 个整页 SVG 侧车；本轮 2018–2019 正式 PDF/视觉预览/DOCX/OLE 图形批次新增 402 个 SVG 侧车；本轮 2024 新课标理综整卷新增 19 个整页 PDF SVG 侧车，物理/化学题目引用 33 次；本轮 2021 全国甲卷新增 24 个整页/答案页 SVG 侧车；本轮 2025 单科 DOCX 批次新增 473 个 PNG→SVG 侧车，物理/化学题目引用 565 次；本轮 2020 全国卷Ⅱ、Ⅲ理综图像 DOCX 新增 43 个整页 SVG 侧车，物理/化学题目引用 70 次；本轮 2023 年 6 套地方/全国卷嵌套 DOCX 新增 1,108 个媒体 SVG，物理/化学题目引用 1,326 次。SVG 是内嵌原始栅格/原始格式容器，保留来源映射，不宣称完成路径级矢量重绘。
