...
function WelcomeScreen({ subject, onExampleClick }: { subject: string; onExampleClick: (text: string) => void }) {
  ...
  return (
    <div ref={containerRef} className="h-full flex flex-col relative overflow-hidden min-h-0">
      ...
      {messages.length === 0 && !hasSubAgentPane ? (
        <WelcomeScreen subject={subject} onExampleClick={(text) => setInput(text)} />
      ) : (
