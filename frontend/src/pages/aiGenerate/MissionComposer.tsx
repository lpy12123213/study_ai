...
export function MissionComposer(props: MissionComposerProps) {
  ...
  return (
    <section className="overflow-hidden rounded-[32px] border border-border/70 bg-background/80 shadow-[0_30px_100px_rgba(33,38,56,0.08)] backdrop-blur">
      <div className="flex flex-col gap-6 p-6 lg:p-8">
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1.6fr)_minmax(280px,0.8fr)]">
          <div className="rounded-[28px] border border-border/60 bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(252,249,242,0.95))] p-4 shadow-sm lg:p-5">
            ...
            <Textarea
              ...
              className="mt-3 min-h-[124px] rounded-[24px] border-border/70 bg-background px-5 py-5 text-base leading-7 text-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]"
              placeholder="例如：为高一数学生成 5 道函数单调性中等难度题，包含答案和解析，并优先参考最近自学资料。"
            />
            <div className="mt-3 rounded-[20px] border border-blue-200/80 bg-blue-50/70 px-4 py-3 text-sm text-blue-900">
